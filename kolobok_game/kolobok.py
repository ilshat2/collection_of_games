...
kolobok = pygame.image.load('collection_of_games/kolobok_game/assets/kolobok.png')
...
fox = []
for i in range(8):
    fox.append(pygame.image.load(f'collection_of_games/kolobok_game/assets/fox{i+1}.png'))
